...
$.extend($.fn.validatebox.defaults.rules,{
       ...
       dataKosong:{validator:function(value,param){
            var data={};
            param[2] = value;
            data[param[1]]=value;
            var hasil = $.ajax({url:param[0],dataType:"json",data:data,async:false,cache:false,type:"post"}).responseText;
            return hasil =="true";
            },
            message:"Data dengan ID {2} sudah ada"
        },
       dataEditKosong:{validator:function(value,param){
            var data={};
            param[2] = value;
            data[param[1]]=value;
            var hasil = $.ajax({url:param[0],dataType:"json",data:data,async:false,cache:false,type:"post"}).responseText;
...
function beforeSendForm (url,params) {
